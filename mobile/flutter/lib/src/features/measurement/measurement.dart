import 'package:apparule/src/features/measurement/guide_screen.dart';
import 'package:apparule/src/app/welcome_screen.dart';
          ...
          Positioned(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.of(
                  context,
                ).push(MaterialPageRoute(builder: (context) => GuideScreen()));
              },
              child: Card(
                color: Color.fromRGBO(20, 5, 98, 0.837),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8.0),
                  side: BorderSide(color: Color(0xFF5A5A5A), width: 1.0),
                ),
                child: Container(
                  width: double.infinity,
                  height: 142,
