...
.DEFAULT_GOAL := help
.PHONY: help up down build rebuild logs ps restart clean tf-init tf-plan tf-apply tf-destroy mobile-goldens
...
mobile-goldens: ## Regenerate mobile CI goldens on Linux (the gate's platform) via Docker
