...
| --- | --- | --- |
| `assets/seed/<flavor>/me.json` | Signed-in test user: non-designer, vault populated across all three freshness states, follows several designers | web §6 "signed-in test user" |
